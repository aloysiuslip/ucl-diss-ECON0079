...
\begin{align}
    ...
    (\mathbb I-\mathbf W)\mathbf y_{t} &= \gamma_t \boldsymbol\iota
                    + \beta_0
    ...
    (\mathbb I-\mathbf V) \mathbf y_{t} &= \gamma_t \boldsymbol\iota
                    + \beta_0
...
\end{align}
Notice the absence of a firm fixed effect component $\alpha_i$ in equations
\eqref{eq:ext-lnfe-reduced} and \eqref{eq:ext-gnfe-reduced}
and the corresponding lack of need to first-difference the reduced form equation.
