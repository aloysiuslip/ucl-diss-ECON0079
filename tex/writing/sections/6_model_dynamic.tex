...
The static model requires an exogeneity assumption of
$\mathbb E[\varepsilon_{i,t}\cdot \begin{pmatrix}
...
Additionally, I introduce a lagged autoregressor as another component of TFP.
\begin{align}
    \label{eq:dyn-main-reduced}
    z_{i,t} &= \alpha_i + \gamma_t + \beta_0 + \phi_1 y_{i,t-1} + \mathbf z_t^{spill}\theta_0 + \varepsilon_{i,t}
    \\
...
The dynamic panel specification uses a time-varying error orthogonality assumption to find valid identification.
This rather than the static model's contemperaneous classical regressor exogeneity,
and even weak cross-sectional error orthogonality between peer in \ref{ss:model-lmm}.
...
\end{align}
\par
There are good reasons to think weak cross-sectional correlation exists.
