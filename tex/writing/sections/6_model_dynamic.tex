...
\wraptable
    ...
    {\begin{itemize}
        \item[] Hansen J-test for over-identification: `\text{\sffamily X}' indicates insuficient evidence
        ...
        \item[] Anderson-Rubin AR(2) test: `\text{\sffamily X}' indicates insufficient evidence to
...
\wraptable
    ...
    {Hansen J-test for over-identification: `\text{\sffamily X}' indicates insuficient evidence
    at the 95\% level to reject the null-hypothesis that the model is identified.
