...
\par
In practice however, due to the limitations of this analysis using Fame's annual frequency observations,
it is unlikely that more-than-one period spillover lag is relevant.
\todo{I test this briefly in appendix}
I show the structural equations in an AR(1,0) structure
