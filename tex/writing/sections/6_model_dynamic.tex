...
The previous section's static model requires a strict factor exogeneity assumption
...
There are significant theoretical advantages to introducing the $q$-lags of the spatial spillover.
...
There are two approaches to this: capital and labour could be fully flexible inputs,
meaning they are optimised as part of the decision set at time $t$,
of which the TFP error shock is a component.
Or, capital and labour can be assumed to be predetermined:
...
\begin{align}
    ...
    \\
    \label{eq:dyn-identification-factor-exogeneity}
    \mathbb E[
        \varepsilon_{i,t}
        \vert
        \begin{pmatrix}
...
Devising an internal instrument requires a similar evaluation of thecomponents of $y_{j,t}$ as in the static problem.
...
\wraptable
    ...
    {../../model/output/instr_3a_identif}
    {\begin{itemize}
        \item[] Hansen J-test for over-identification: `\textsf{X}' indicates insuficient evidence
        ...
        \item[] Anderson-Rubin AR(1) test:  `\checkmark' indicates the use of single-order lags is a weak instrument,
                as expected from a first-differencing SystemGMM approach.
        \item[] Anderson-Rubin AR(2) test: `\textsf{X}' indicates insufficient evidence to
                ...
                as expected from the first-differencing with lags greater than 2nd-order to overcome contemperaneous endogeneity.
...
\wraptable
    ...
    {Hansen J-test for over-identification: `\textsf{X}' indicates insuficient evidence
    at the 95\% level to reject the null-hypothesis that the model is identified.
