...
with a structural $\delta$ parameter to estimate.
...
\begin{align}
    ...
    y_{i,t} &= \alpha_i + \gamma_t + \beta_0
                ...
                + \varepsilon_{i,t}
    \\
    z_{i,t} &= y_{i,t} - \alpha l_{i,t} - \beta k_{i,t} = \ln(A_{it}) 
    \\
    \label{eq:static-main-reduced}
    z_{i,t} &= \alpha_i + \gamma_t + \beta_0 + \delta \sum_{j\neq i} w_{ij}z_{j,t} + \varepsilon_{i,t}
\end{align}

Theory suggests no restrictions on $\beta_1$, $\beta_2$, and $\delta$ collectively should be imposed,
as $\delta$ is an externality. \todo{Lucas discusses this}
\par
...
This permits me to estimate structural $\delta$ through either
...
\begin{align}
    ...
    z_{i,t} &= \alpha_i + \gamma_t + \beta_0
                + \delta \sum_{j\neq i} w_{ij} \cdot
                    (\alpha_i + \gamma_t + \beta_0 + \varepsilon_{j,t})
                + \varepsilon_{i,t}
    \\
    \Delta z_{i,t} &= \Delta\gamma_t
                + \delta \sum_{j\neq i} w_{ij} \cdot
                (\Delta\gamma_t + \Delta\varepsilon_{j,t})
...
\begin{align*}
    \Delta z_{i,t} &= \Delta \gamma_t + \delta \sum_{j\neq i} w_{ij}\Delta z_{j,t} + \Delta \varepsilon_{i,t}
    \\
    \Delta \mathbf z_t &= \Delta \gamma_t \mathbf\iota
                        + \delta  \mathbf W \Delta \mathbf z_t
                        + \Delta \mathbf \varepsilon_t
    \\
    &= (\mathbb I -\delta \mathbf W)^{-1} 
        (\Delta \gamma_t\mathbf\iota + \Delta\mathbf \varepsilon_t)
\end{align*}
