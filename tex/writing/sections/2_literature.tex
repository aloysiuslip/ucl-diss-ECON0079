...
The paper exploits many complex interaction structures summarised by the weighting matrix $\mathbf W$,
...
are also equivalently permissible, as I apply in this analysis in section \ref{ss:model-dd}.
