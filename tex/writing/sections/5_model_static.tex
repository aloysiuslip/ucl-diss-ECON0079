...
Results for the 3 respective reciprocal distance measures are given in \tablerefp{tab:dd-basic-str}.
Note that each of the distance $d_1, d_2, d_3$ measures are non-orthogonal, distinct transformations
