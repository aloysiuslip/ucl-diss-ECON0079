...
\begin{table}[hbtp]
    ...
    \begin{threeparttable}
        ...
        \label{tab:lmm-pc8}
        \input{../../model/output/results_1a_lmm_pc8}
    \end{threeparttable}
    \\~\\
    \vspace{1em}
    \begin{threeparttable}
...
\wraptable
    {Static panel IV estimation using continuous distance-decay weighted TFP average of peers}
    {../../model/output/results_2a_dd}
    {}
\wraptable
    {Static panel IV performance with deeper lags}
    {../../model/output/results_2b_dd_deeper}
    {}

% \begin{table}[hbtp]
%     \centering
%     \begin{threeparttable}
%         \caption{Static panel IV estimation using continuous distance-decay weighted TFP average of peers}%
%         \label{tab:dd}
%         \input{../../model/output/results_2a_dd}
%     \end{threeparttable}
%     \\~\\
%     \vspace{1em}
%     \begin{threeparttable}
%         \caption{Static panel IV performance with deeper lags}
%         \label{tab:dd_deeper}
%         \input{../../model/output/results_2b_dd_deeper}
%         \begin{tablenotes}
%             All parameters reported with standard errors underneath.
%             Significant estimates against an $H_0: \beta=0$ are indicated
%             with $p<0.1$ (*), $p<0.05$ (**), and $p<0.01$ (***).
