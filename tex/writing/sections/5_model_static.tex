...
\wraptable
        ...
        {../../model/output/final/results_1a_lmm_pc8}
        {}
...
\begin{table}[hbtp]
    ...
    \vspace{0.5em}
    \begin{threeparttable}
        \caption{Static panel IV $\mathbf W_d$, zero distances excluded}
        \label{tab:dd-noz-str}
        \input{../../model/output/results_2b_dd_noz_str}
        \begin{tablenotes}
            \centering
            \begin{footnotesize}
                Starts denote significance against an $H_0$
                with the usual confidence levels, \\*
                but these are not meaningful for this analysis. \\*
                All models run with time and fixed effects.            
            \end{footnotesize}
        \end{tablenotes}
    \end{threeparttable}
\end{table}
...
against the instruments employed.
...
\\
\pagebreak
To investigate this issue, I run an extension where firms which share a location, meaning distance is mechanically 0, are excluded.