...
At first glance, it may appear that this model follows the structure of the peer effect class of models too
...
this model is actually non-identified. I demonstrate this in the next section \ref{ss:static-identification}.
\par
...
As a brief extension, I explore the possibility of regressing multiple, non-overlapping spatial groups at once.
...
which here is theroetically guaranteed by the mutual orthogonality of $\mathbf W_g$.
...
which intuitively represents all firms in a \itx{ttwa} can be used in higher orders \eqref{eq:static-3r-sum-instr}.
\begin{align}
...
However, in practice with this dataset,
regressing more groups has proved unlikely to offer more insights
...
\par
This extension is interesting and useful, because the assignment of groups,
...
for example, through industry or regional cuts.
Perhaps these will have more success by producing independent, orthogonal matrices
than the multiple orthogonal groups extension run here.
...
\begin{align}
    \Delta y_{i,t} &= \Delta\gamma_t
                    ...
                    + \Delta \varepsilon_{i,t}
    \\
    \eqreref{eq:static-dd-moment-conditions}
    \mathbb E &[
        \epsilon_{i,t}\ 
        \vert
        \begin{pmatrix}
...
were this specification to be ran through 2SLS\footnote{Noting that in practice,
...
Results are reported in \ref{tab:dd-noz-str}.
On evaluation by $R^2$ thes models perform slightly worse.
